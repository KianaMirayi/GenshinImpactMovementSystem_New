...
namespace GenshinImpactMovementSystem
{
    ...
    */
    ...
    public abstract class StateMachine  //抽象类
    {
        ...
        public void OnAnimationTransitaionEvent()
        { 
            currentState?.OnAnimationTransitaionEvent();
        }

        public void OnTriggerEnterEvent(Collider collider)
        {
            currentState?.OnTriggerEnterEvent(collider);
        }

        public void OnTriggerExitEvent(Collider collider)
        { 
            currentState?.OnTriggerExitEvent(collider);
        }
    }
}
